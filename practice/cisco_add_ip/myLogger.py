...
def getLogger(consoleLevel = logging.DEBUG, fileLevel = logging.INFO, fileName = "log.log"):
    ...
    currentFormat = logging.Formatter('%(asctime)s - pid [%(process)d] - %(filename)s [line:%(lineno)d] - %(levelname)s: %(message)s')
