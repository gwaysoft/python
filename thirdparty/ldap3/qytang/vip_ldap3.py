...
group_dn = 'CN=vipgroup,OU=LDAP_VIP,DC=qytang,DC=com'
...
server = Server('ldaps://10.1.1.100', get_info=ALL, use_ssl=True)
...
def get_user_group(username, password):
    ...
    try:
        ...
        c.search(search_base='dc=qytang,dc=com', search_filter='(&(samAccountName=' + username + '))', attributes=['memberOf', 'sn', 'department'], paged_size=5)
...
if __name__ == "__main__":
    ...
    print(get_user_group('vipadmin', 'Cisc0123'))
