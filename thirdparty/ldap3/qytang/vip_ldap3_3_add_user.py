...
# 添加域账号
def add_ad_user(xingming, phone, qq, mail, group='vipgroup', random_pass=False):
    # 转换汉字到拼音
    hanzi = xingming
...
if __name__ == '__main__':
    print(add_ad_user('秦柯', '13297055555', '2350512555', '2350512555@qq.com', 'vipgroup'))
